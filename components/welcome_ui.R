fluidPage(
  div(class="jumbotron welcome_panel",
      ...
      br(),
      h6("*This dashboard was developed using Shiny and the data source we rely on are from https://ourworldindata.org/coronavirus-source-data and https://www.moh.gov.sg/covid-19"),
  ),
